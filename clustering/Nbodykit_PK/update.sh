...
REPO=https://github.com/akrolewski/nkit4desi.git # replace this with your repository URL
FOLDER=clustering/Nbodykit_PK/nkit4desi # where to mount the subtree
