...
CMASS50JKx0 = np.loadtxt('covariances/covariance_xi0xi0_rsd.txt')
CMASS50JKx2 = np.loadtxt('covariances/covariance_xi2xi2_rsd.txt')
CMASS50JKx4 = np.loadtxt('covariances/covariance_xi4xi4_rsd.txt')
CMASS50JKx0x2 = np.loadtxt('covariances/covariance_xi0xi2_rsd.txt')
CMASS50JKx2x0=np.transpose(CMASS50JKx0x2)
CMASS50JKx0x4 = np.loadtxt('covariances/covariance_xi0xi4_rsd.txt')
CMASS50JKx4x0=np.transpose(CMASS50JKx0x4)
CMASS50JKx2x4 = np.loadtxt('covariances/covariance_xi2xi4_rsd.txt')
...
np.savetxt('covariances/covariance_ful_rsd.txt', df.values,fmt='%ld %ld %.12f')
np.savetxt('covariances/normalised_covariance_full_rsd.txt', dfnorm.values,fmt='%ld %ld %.12f')
