!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! Covariance matrices for real-space EZmocks multipoles
! for any issue please contact ginevra.favole@port.ac.uk
!-------------------------------------------------------
!compile as:
!  ifort -fopenmp covariances_real.f90 -o covreal
!execute as:
! ./covreal
...
program main
  implicit none
  CHARACTER(150), PARAMETER   :: inputcat='multipoles/mean_multipoles_real.txt'
  CHARACTER(150), PARAMETER   :: output00='covariances/covariance_xi0xi0_real.txt'
  CHARACTER(150), PARAMETER   :: output22='covariances/covariance_xi2xi2_real.txt'
  CHARACTER(150), PARAMETER   :: output44='covariances/covariance_xi4xi4_real.txt'
  CHARACTER(150), PARAMETER   :: output02='covariances/covariance_xi0xi2_real.txt'
  CHARACTER(150), PARAMETER   :: output04='covariances/covariance_xi0xi4_real.txt'
  CHARACTER(150), PARAMETER   :: output24='covariances/covariance_xi2xi4_real.txt'
  CHARACTER(150), PARAMETER   :: outputsigma00='covariances/sigma_xi0_real.txt'
  CHARACTER(150), PARAMETER   :: outputsigma22='covariances/sigma_xi2_real.txt'
  CHARACTER(150), PARAMETER   :: outputsigma44='covariances/sigma_xi4_real.txt'
...
10 FORMAT('multipoles/xilreal_',I3.3,'.txt')
