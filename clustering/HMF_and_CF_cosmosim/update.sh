...
REPO=https://github.com/cejgrove/HMF_CF.git # replace this with your repository URL
FOLDER=clustering/HMF_and_CF_cosmosim/HMF_CF # where to mount the subtree
